 ...
 * 2,000 iterations: ~80ms on desktop, ~100-300ms on mobile Hermes (imperceptible).
 * 20,000 was 2-5s+ on phones (pure-JS PBKDF2-SHA512 blocks the UI thread) — reduced 2026-08-22.
 * NOTE: Accounts encrypted with the old 20k iteration count must be re-imported.
