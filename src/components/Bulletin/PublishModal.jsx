...
import { PublishBulletin, BulletinFileAdd, BulletinFileDel } from '../../store/sagas/messenger.actions';
import { setPublishFlag, setPublishTagList } from '../../store/slices/MessengerSlice';
...
export default function PublishModal({ visible, onClose }) {
  ...
  const handleAddTag = useCallback(() => {
    ...
    if (publishTags.length >= ListItemMax) {
      dispatch(setFlashNoticeMessage({
  ...
  const handleRemoveFile = useCallback((fileHash) => {
  ...
  const canSubmit = content.trim().length > 0 && publishTags.length <= ListItemMax;
        ...
        >
          ...
          <View style={styles.body}>
            ...
            <View style={styles.tagSection}>
              <Text style={styles.sectionLabel}>Tags (max {ListItemMax})</Text>
